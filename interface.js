...
function selectionHtml(){
  ...
  if(selected.type==="base"){
    ...
    const unloadingNote=destroyed?"":`<div class="selection-subtitle">Trains will only fill resources to 110 units so that they don't endlessly dump resources into the base building and starve buildings that need those resources</div>`;
