...
function selectionHtml(){
  ...
  if(selected.type==="neutralizer")return `<div class="selection-title"><h2>Neutralizer ally</h2></div><div class="selection-subtitle">Seeks the nearest creep or hive · Shoots every ${displayStat(neutralizerFireInterval())} second(s) for ${displayStat(neutralizerDamage())} damage · Can pass through gates but not walls, mountains, trees, or water</div>${hpBlock(selected)}`;
