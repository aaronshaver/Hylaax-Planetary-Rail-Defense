...
function selectionHtml(){
  ...
  if(selected.type==="hive"){const rate=selected.level;return `<div class="selection-title"><h2>Level ${rate} Hive</h2></div><div class="selection-subtitle">${rate} Creeps per batch · 1 in ${rate} expansion chance</div>${hpBlock(selected)}`;}
