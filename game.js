...
if(window.__HYLAAX_TEST__){
  window.__HYLAAX_TEST_API__={
    ...
    key,fromKey,hexDistance,neighbors,creepOccupiesHex,footprintPerimeter,axialToWorld,worldToAxial,hexLineBetween,hasClearShot,baseTerrainAt,resourceHasOpenApproach,terrainAt,isPassable,terrainCanReachBase,resourceNodeAt,setNodeAmount,centerMapOnBase,
    ...
    connectedTrackNeighbors,conceptualTrackNeighbors,tracksAreLinked,linkTracks,deleteTrack,curveIsExtreme,resupplyTrainStops,trainStopWithinRange,constructionStopRequirement,requireNearbyTrainStop,requireNoCreep,layTrack,placeTrackOverGhost,buildTurret,buildMine,buildWall,buildArtillery,clearDepletedResourceNode,salvageBurst,salvageStructure,clearGhost,requestTrainSalvage,requestResearchSalvage,cancelTrainSalvage,confirmTrainSalvage,deploymentPathsFrom,deployTrain,
